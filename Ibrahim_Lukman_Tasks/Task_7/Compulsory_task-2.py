...
guardian_contact = input("Enter guardian's phone number: ")

# Hobbies
input_hobies = input("Kindly enter at least 3 hobbies (comma-separated): ")
hobbies_set = set(x.strip() for x in input_hobies.split(","))
